...
private:
  ...
  ///< \brief the default & user-defined chunk size
  static const int default_chunk_size_ = 10;

  ///< \brief the list stores objects that are not currently in use by clients
